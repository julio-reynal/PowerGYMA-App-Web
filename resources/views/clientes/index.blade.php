...
@push('styles')
    @vite(['resources/css/components.css', 'resources/css/clientes.css', 'resources/css/contacto-figma.css'])
@endpush
...
@push('scripts')
    @vite(['resources/js/components.js', 'resources/js/clientes.js', 'resources/js/contacto-figma.js'])
@endpush