...
<head>
    ...
    <meta name="description" content="Power GYMA - Sistema de Gestión y Monitoreo de Energía" />
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 640px) {
            .container { 
                padding: 1rem; 
                min-height: 100vh;
                min-height: 100dvh; /* dvh para móviles */
            }
            .welcome-card { 
                padding: 2rem 1.5rem;
                margin: 1rem 0;
        ...
        /* Media queries adicionales para diferentes tamaños */
