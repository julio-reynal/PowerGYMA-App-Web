        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="format-help">
                    ...
                    <ul>
                        <li><i class="fas fa-check"></i> Archivos: CSV, XLSX o XLS</li>
                ...
                <form id="uploadForm" action="{{ route('admin.excel.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <script>
        ...
        function handleFiles(files) {
            if (files.length > 0) {
                ...
                // Show file name
                fileName.innerHTML = `<i class="fas fa-file-excel"></i> ${file.name} (${(file.size / 1024).toFixed(1)} KB)`;
