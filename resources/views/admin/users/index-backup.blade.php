  ...
  (function() {
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* Badges modo oscuro */
        html[data-theme="dark"] .badge-admin { color: #fca5a5; }
        html[data-theme="dark"] .badge-cliente { color: #6ee7b7; }
        html[data-theme="dark"] .badge-demo { color: #fcd34d; }
        html[data-theme="dark"] .badge-entrenador { color: #67e8f9; }
        html[data-theme="dark"] .badge-active { color: #6ee7b7; }
        html[data-theme="dark"] .badge-inactive { color: #fca5a5; }
        html[data-theme="dark"] .badge-expired { color: #fcd34d; }
        html[data-theme="dark"] .badge-current { color: #67e8f9; }
...
<body>
    <header class="header">
        ...
        <div class="user-info">
            <button id="theme-toggle" class="theme-toggle" onclick="toggleTheme()" aria-label="Cambiar tema" title="Cambiar tema">
                <div class="flex items-center justify-center w-6 h-6 relative" style="width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; position: relative;">
                    <span id="light-icon" class="absolute transition-all duration-300 transform" style="position: absolute; transition: all 0.3s;">
                        <i class="fas fa-moon" style="color: var(--text-muted);"></i>
                    </span>
                    <span id="dark-icon" class="absolute transition-all duration-300 transform opacity-0 rotate-180" style="position: absolute; transition: all 0.3s; opacity: 0; transform: rotate(180deg);">
    ...
    <div class="container fade-in">
        <div class="page-header">
            ...
            <div class="action-buttons">
                ...
                <a href="{{ route('admin.users.create-demo') }}" class="btn btn-warning">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Inicializar iconos del toggle
            updateThemeToggleIcons();
        });

        // Toggle de tema mejorado con animaciones
