                    ...
                    <div class="card-body">
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                            ...
                            <div class="field-group editable-field">
                                ...
                                <div class="field-value editable" onclick="editField('cargo_puesto')">
                                    {{ $demoRequest->cargo_puesto ?? 'No especificado' }}
                                </div>
                                <div class="edit-overlay">
                                    <button class="edit-btn" onclick="editField('cargo_puesto')">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="field-group">
                                <div class="field-label">Giro de Empresa</div>
                                <div class="field-value">
                                    {{ $demoRequest->giro_empresa ?? 'No especificado' }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem;">
                            <div class="field-group">
                                ...
                                <div class="field-value">
                                    @if($demoRequest->tipo_demo == 'evaluacion')
                                        <span class="badge badge-primary">
                                            <i class="fas fa-search"></i>
                                            Evaluación del Sistema
                                        </span>
                                    @elseif($demoRequest->tipo_demo == 'prueba_gratis')
                                        <span class="badge badge-success">
                                            <i class="fas fa-gift"></i>
                                            Prueba Gratuita
                                        </span>
                                    @elseif($demoRequest->tipo_demo == 'consultoria')
                            ...
                            <div class="field-group editable-field">
                                <div class="field-label">Demo Programada</div>
                                <div class="field-value editable" onclick="editField('fecha_demo_programada')">
                                    {{ $demoRequest->fecha_demo_programada ? $demoRequest->fecha_demo_programada->format('d/m/Y H:i') : 'No programada' }}
                                </div>
                                <div class="edit-overlay">
                                    <button class="edit-btn" onclick="editField('fecha_demo_programada')">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="field-group">
                                <div class="field-label">Origen de Solicitud</div>
                                <div class="field-value">
                                    {{ ucfirst($demoRequest->origen_solicitud ?? 'Web') }}
                                </div>
                            </div>
                        </div>
                    </div>
