    ...
    <div class="container fade-in">
        ...
        <div class="stats">
            ...
            <div class="stat-card stat-info">
                ...
                <div class="stat-number">{{ $estadisticas['contactados'] }}</div>
            ...
            <div class="stat-card stat-success">
                ...
                <div class="stat-number">{{ $estadisticas['programados'] }}</div>
            ...
            <div class="stat-card stat-secondary">
                ...
                <div class="stat-number">{{ $estadisticas['recientes'] }}</div>
            ...
            <form method="GET" action="{{ route('admin.demo-requests.index') }}" id="filterForm">
                ...
                <div class="filter-actions">
                    <span class="text-muted" style="color: var(--text-muted);">
                        Mostrando {{ $solicitudes->count() }} de {{ $estadisticas['total'] }} solicitudes
                    </span>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 0.9rem; color: var(--text-muted);">
                                {{ $request->fecha_demo_programada ? $request->fecha_demo_programada->format('d/m/Y') : 'No programada' }}
                                <br>
                                <small>{{ $request->fecha_demo_programada ? $request->fecha_demo_programada->format('H:i') : '--:--' }}</small>
                            </td>
                            <td>
